...
class Router
{
	...
	public function add($route, $params = [])
	{
		...
		//Convert variables with custom regular expressions e.g. {id:\id+}
	...
	/**
		...
		A URL of the format localhost/?page (one variable name, no value ) won't work however.(NB. The .htaccess converts the first ? to & when it's passed through the $_SERVER variable)

		@param string $url The full URL
		@return the URL with query string variables removed
	**/
